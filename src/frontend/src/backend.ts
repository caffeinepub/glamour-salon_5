...
import type { Booking as _Booking, BookingStatus as _BookingStatus, ExternalBlob as _ExternalBlob, SalonService as _SalonService, ServiceCategory as _ServiceCategory, StripeSessionStatus as _StripeSessionStatus, StylistProfile as _StylistProfile, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addService(arg0: SalonService): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addService(to_candid_SalonService_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBooking(arg0: string, arg1: string, arg2: Time, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBookingsByStylist(arg0: string): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsByStylist(arg0);
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomerBookings(arg0: Principal): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomerBookings(arg0);
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyEarnings(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyEarnings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEarningsByCategory(): Promise<Array<[ServiceCategory, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEarningsByCategory();
    ...
    async getService(arg0: string): Promise<SalonService | null> {
        if (this.processError) {
            try {
    ...
    async getServices(): Promise<Array<SalonService>> {
        if (this.processError) {
            try {
    ...
    async getStylist(arg0: string): Promise<StylistProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getStylist(arg0);
    ...
    async updateService(arg0: SalonService): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateService(to_candid_SalonService_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_SalonService_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SalonService): SalonService {
    return from_candid_record_n33(_uploadFile, _downloadFile, value);
}
function from_candid_ServiceCategory_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ServiceCategory): ServiceCategory {
...
async function from_candid_StylistProfile_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StylistProfile): Promise<StylistProfile> {
...
function from_candid_opt_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SalonService]): SalonService | null {
    return value.length === 0 ? null : from_candid_SalonService_n32(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StylistProfile]): Promise<StylistProfile | null> {
    return value.length === 0 ? null : await from_candid_StylistProfile_n40(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: from_candid_ServiceCategory_n29(_uploadFile, _downloadFile, value.category),
        price: value.price
    };
}
...
async function from_candid_record_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        beforeAfterPhotos: await from_candid_vec_n42(_uploadFile, _downloadFile, value.beforeAfterPhotos),
...
function from_candid_tuple_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_ServiceCategory, bigint]): [ServiceCategory, bigint] {
    return [
        from_candid_ServiceCategory_n29(_uploadFile, _downloadFile, value[0]),
        value[1]
    ];
}
...
function from_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "popular" in value ? ServiceCategory.popular : "seasonal" in value ? ServiceCategory.seasonal : "classic" in value ? ServiceCategory.classic : "trending" in value ? ServiceCategory.trending : value;
}
...
function from_candid_vec_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_ServiceCategory, bigint]>): Array<[ServiceCategory, bigint]> {
    return value.map((x)=>from_candid_tuple_n28(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SalonService>): Array<SalonService> {
    return value.map((x)=>from_candid_SalonService_n32(_uploadFile, _downloadFile, x));
}
...
async function from_candid_vec_n44(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StylistProfile>): Promise<Array<StylistProfile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StylistProfile_n40(_uploadFile, _downloadFile, x)));
}
...
function to_candid_SalonService_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SalonService): _SalonService {
...
async function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        experienceYears: value.experienceYears,
        beforeAfterPhotos: await to_candid_vec_n14(_uploadFile, _downloadFile, value.beforeAfterPhotos),
        specialties: value.specialties,
        rating: value.rating
    };
}
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        description: value.description,
        durationMinutes: value.durationMinutes,
        category: to_candid_ServiceCategory_n10(_uploadFile, _downloadFile, value.category),
        price: value.price
    };
}
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceCategory): {
    ...
    return value == ServiceCategory.popular ? {
        popular: null
    } : value == ServiceCategory.seasonal ? {
        seasonal: null
    } : value == ServiceCategory.classic ? {
        classic: null
    } : value == ServiceCategory.trending ? {
        trending: null
    } : value;
}
